...
const Workshops = () => {
  ...
  const upcomingWorkshops = [
    { title: 'Hands-on CRISPR Workshop', date: 'July 15, 2025', time: '10:00 AM - 4:00 PM', location: 'Hyderabad' },
    { title: 'Advanced Peptide Synthesis', date: 'August 5, 2025', time: '9:00 AM - 3:00 PM', location: 'Hyderabad' },
    { title: 'Bioinformatics for Researchers', date: 'September 10, 2025', time: '11:00 AM - 5:00 PM', location: 'Hyderabad' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <section className="relative h-[40vh] md:h-[50vh] flex items-center justify-center text-white overflow-hidden bg-gradient-to-br from-blue-700 to-purple-600">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-extrabold mb-4 drop-shadow-lg">Workshops</h1>
          <p className="text-lg md:text-xl max-w-3xl mx-auto px-4">
            Practical, hands-on learning experiences led by experts
          </p>
        </motion.div>
      </section>
      ...
      <section className="w-full py-12 px-4 lg:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Upcoming Workshops</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            {upcomingWorkshops.map((workshop, index) => (
              ...
              >
                <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">{workshop.title}</h3>
                <div className="text-sm text-gray-700 space-y-2 mb-6 text-center">
                  <div className="flex items-center justify-center gap-2"><Calendar className="w-4 h-4" /> {workshop.date}</div>
                  <div className="flex items-center justify-center gap-2"><Clock className="w-4 h-4" /> {workshop.time}</div>
          ...
          <motion.div
            ...
            className="mb-16"
          >
            <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">Workshop Categories</h3>
          ...
          <motion.div
            ...
            className="mb-16"
          >
            <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">Benefits</h3>
