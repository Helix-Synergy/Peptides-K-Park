...
//   Check, Award, Users, Leaf, Clock, Package, FlaskConical, Cloud, Wrench, Microscope, Locate, Trash2, Sparkles, Handshake, TrendingUp, Lightbulb
// } from "lucide-react";
...
//       {/* Hero Section */}
//       <header className="relative w-full h-[50vh] flex items-center justify-end text-center bg-cover bg-center" style={{ backgroundImage: `url('https://placehold.co/1920x800/f0e8e4/1e1e1e?text=Analytes+Assessment+Services')` }}>
...
//             Your trusted partner for comprehensive testing and analysis.
//           </p>
//           <motion.a
//             href="#services"
...
//                     className="group bg-white shadow-lg rounded-2xl p-6 hover:bg-gradient-to-r hover:from-[#714819] hover:to-[#b2874b] hover:text-white transition-all duration-300 cursor-pointer flex gap-4 items-start border border-gray-200"
//                   >
//                     <item.icon size={64} className="text-[#714819] group-hover:text-white transition-all duration-300" />
...
//                 <h4 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-[#0f2920] to-[#714819]">Get Started Today</h4>
//                 <p className="text-gray-700 mb-6">{selectedService.content.cta}</p>
//                 <motion.button
//                   variants={glowAnimation}
//                   whileHover="whileHover"
